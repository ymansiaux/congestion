...
```{r traficolorCleaning, message=FALSE, cache=TRUE}
...
```{r traceDesTroconsTraficolor, cache=TRUE}
...
```{r jointureTronconsCongestion, cache = TRUE}
...
```{r cleanDataCapteurs, message = FALSE, cache = TRUE}
...
```{r recupDataTempsParcours, cache = TRUE}
